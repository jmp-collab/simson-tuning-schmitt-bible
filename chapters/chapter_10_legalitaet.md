...
```mermaid
graph TD
    Start["👨‍🔧 Motor mit Schmitt-Teilen aufbauen <br>(z.B. Sportfreund 70cc / VAPE)"] --> Concept["1. Absprache mit dem TÜV-Sachverständigen"]
    Concept --> FrameUp["2. Chassis-Verstärkung montieren <br>(Schmitt CNC-Teile)"]
    FrameUp --> Dyno["3. Leistungsmessung auf dem Prüfstand"]
    Dyno --> Inspection["4. Vollabnahme nach § 21 StVZO"]
    
    Inspection -->|Mängel gefunden| Fix["🔧 Mängel beheben & Wiedervorstellung"]
    Inspection -->|Bestanden| Paperwork["5. Erhalt des Gutachtens"]
    
    Fix --> Inspection
    Paperwork --> Registration["6. Zulassungsstelle: Großes Kennzeichen abholen"]
    
    Registration --> THG["💸 THG-Quote einreichen & jährliche Prämie kassieren!"]

    classDef default fill:#f9f,stroke:#333,stroke-width:2px;
    class THG fill:#bbf,stroke:#f66,stroke-width:2px;
```

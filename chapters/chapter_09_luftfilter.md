...
<p align="center">
  <img src="https://img.shields.io/badge/Akt-IX%20Der%20Orkan-black?style=flat-square" alt="Act 9">
  <img src="https://img.shields.io/badge/SEO-Simson%20Sportluftfilter%20einbauen-brightgreen?style=flat-square" alt="SEO">
...
```mermaid
graph TD
    Start["❓ Motor stottert bei Vollgas und qualmt schwarz?"] --> CheckFilter["1. Luftfilterpatrone schmutzig oder mit Getriebeöl getränkt?"]
    CheckFilter -->|Ja| CleanFilter["🔧 Filter reinigen / trockenlegen"]
    CheckFilter -->|Nein| CheckIntake["2. Ansaugschlauch geknickt oder verengt?"]
    
    CheckIntake -->|Ja| FixHose["🔧 Schlauch gerade verlegen oder austauschen"]
    CheckIntake -->|Nein| StandardAirbox["3. Luftfilterbox hat zu kleinen Einlass für Tuningvergaser?"]

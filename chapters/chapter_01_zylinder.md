...
```mermaid
graph TD
    Start["❓ Kickstarter fällt ohne Widerstand?"] --> CheckHead["1. Zylinderkopf locker oder verzogen?"]
    CheckHead -->|Ja| RepairHead["🔧 Muttern über Kreuz mit 10 Nm anziehen"]
    CheckHead -->|Nein| CheckWear["2. Kolbenringe fest oder Laufbahn zerkratzt?"]
    
    CheckWear -->|Ja| Upgrade["💀 Das Urteil: Verschleißtod der Buchse! <br>Upgrade auf Schmitt Nicasil-Technologie"]
    CheckWear -->|Nein| SparkCheck["3. Zündkerzengewinde im Kopf ausgerissen?"]

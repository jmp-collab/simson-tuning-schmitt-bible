...
```mermaid
graph TD
    Start["❓ Bremse verzögert nicht oder quitscht erbärmlich?"] --> CheckOil["1. Fett auf den Belägen? <br>(Austritt am Radlager?)"]
    CheckOil -->|Ja| Clean["🔧 Nabe mit Bremsenreiniger fluten / Beläge ersetzen"]
    CheckOil -->|Nein| CheckWear["2. Belagsstärke unter 2.0 mm?"]
    
    CheckWear -->|Ja| WearLimit["⚠️ Verschleißgrenze erreicht!"]
    CheckWear -->|Nein| CheckGlaze["3. Reibfläche glänzend und hart? (Verglast)"]

    CheckGlaze -->|Ja| RoughUp["🔧 Belag mit Schmirgelpapier anrauhen"]
    CheckGlaze -->|Nein| AdjustCam["🔧 Nockenhebel um einen Zahn versetzen / Zwischenlagen nutzen"]
